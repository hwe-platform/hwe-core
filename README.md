...
Monorepo de paquetes npm compartidos del proyecto HWE. Contiene `@hwe/core-ui`,
...
hwe-core/
  packages/
    core-ui/        # @hwe/core-ui — bloques, primitivas, renderer, layout, adapters, theme
```
...
es necesario para **publicar** `@hwe/core-ui` (lo hace CI automáticamente)
...
check, test y build. En cada push a `main`, además publica `@hwe/core-ui` a
GitHub Packages.
