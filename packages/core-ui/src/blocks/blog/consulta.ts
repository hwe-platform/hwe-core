 ...
 * a la forma de `card-grid` en lugar de inventar otra: el resumen va de
 * subtítulo y la categoría de etiqueta.
 *
...
export function articuloATarjeta(
  ...
  { locale, readMoreLabel, basePath = '/blog' }: OpcionesDeTarjeta,
): CardGridItem {
  return {
